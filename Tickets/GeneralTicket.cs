...
{
    internal class GeneralTicket : Ticket
    {
        public const string CoachType = "GEN";
        ...
        internal void BookTickets()
        {
            ...
            if (Trains.Count > 0)
            {
                ...
                {
                    if (!PrintUtils.NullCheck(NoOfSeats)) return;
                    if (!int.TryParse(NoOfSeats, out int Seatvalue) || Seatvalue <= 0)
                    {
                        PrintUtils.InputFailure("Enter a valid number of seats");
                        return;
                    }
                    ...
                    else
                    {
                        ...
                        PassengerDetails[0] = random.Next(100, 200).ToString();
                    }
